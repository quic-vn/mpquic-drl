...
declare -a mdlArr=("gm3d") #("none" "gm2d" "rwp2d" "rpgm2d" "gm3d" "rwp3d" "rpgm3d")
...
# declare -a schArr=("rtt" "sac" "fuzzyqsat" "random")
...
# declare -a mdlArr=("none") #("none" "gm2d" "rwp2d" "rpgm2d" "gm3d" "rwp3d" "rpgm3d")
# declare -a numArr=("1") #("1" "3" "5")
# declare -a filArr=("2MB") 
# declare -a bgrArr=("0")
# declare -a frqArr=("0")
