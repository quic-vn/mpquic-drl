...
def read_file(file_path):
    ...
    with open(file_path, 'r') as file:
        for line in file:
            arrstore.append(line.strip())
    return arrstore

# path to store website link
file_path = "listwebsiteclone.txt"

# Call func
web_link = read_file(file_path)
    ...
    class Extractor:
        ...
        def url_to_local_path(self, url, keepQuery=False):
            try:
                ...
                print(f"Error occurred while parsing URL '{url}': {e}")
                return None
        ...
        def download_file(self, url, output_path):
            ...
            # If output_path is a directory, append filename to it
        ...
        #     return True
        def save_html(self):
            output_dir = os.path.join(workspace, output_folder)
